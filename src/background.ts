 ...
 * przy braku wyboru działa jak neutralny, szerokopasmowy szum.
 */
...
chrome.runtime.onInstalled.addListener(async () => {
  ...
  // No bundled API token, no install-time external traffic. Alias integrations
  // become network-active only after explicit user action.
})
